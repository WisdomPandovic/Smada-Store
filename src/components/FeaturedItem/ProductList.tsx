...
import { getProducts } from '../../utils/storage'; // Ensure this path is correct
...
const ProductList: React.FC = () => {
  ...
  return (
    <div className="m-5">
        ...
        {products.map((product) => (
          <div key={product.id} className="border rounded-lg overflow-hidden shadow-md">
            ...
            <div className="p-4 text-center">
              ...
              <p className="text-sm mb-2">{product.description}</p> {/* Adjust margin-bottom */}
              <p className="text-[#f1385f] text-sm mb-4">${product.price.toFixed(2)}</p> {/* Adjust margin-bottom */}
      ...
      <div className="flex justify-center items-center py-4"> {/* Adjust vertical padding */}
